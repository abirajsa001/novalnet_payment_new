...
export class Przelewy24Builder implements PaymentComponentBuilder {
  public componentHasSubmit = true;
  constructor(private baseOptions: BaseOptions) {}

  build(config: ComponentOptions): PaymentComponent {
    return new Przelewy24(this.baseOptions, config);
  }
}
 
export class Przelewy24 extends BaseComponent {
  private showPayButton: boolean;

  constructor(baseOptions: BaseOptions, componentOptions: ComponentOptions) {
    super(PaymentMethod.przelewy24, baseOptions, componentOptions);
  ...
  async submit() {
    ...
    console.log('=== Przelewy24 ENABLER SUBMIT START ===');
  ...
  private _getTemplate() {
    ...
    <div class="${styles.wrapper}">
      <p>Pay easily with Przelewy24 and transfer the shopping amount within the specified date.</p>
