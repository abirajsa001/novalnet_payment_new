...
export class Blik extends BaseComponent {
  ...
  constructor(baseOptions: BaseOptions, componentOptions: ComponentOptions) {
    super(PaymentMethod.blik, baseOptions, componentOptions);
  ...
  async submit() {
    ...
    console.log('=== BLIK ENABLER SUBMIT START ===');
  ...
  private _getTemplate() {
    ...
    <div class="${styles.wrapper}">
      <p>Pay easily with Blik and transfer the shopping amount within the specified date.</p>
